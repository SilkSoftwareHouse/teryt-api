...
class Helper
{
     ...
     * @throws Exception
     */
    public static function getKeyValues(array $tItems, $sKey, $asUnique = true)
    {
        $answer = [];
     ...
     * @throws Exception
     */
    public static function getPropertyAsArray(\stdClass $oObject, $sPropertyName)
    {
     ...
     */
    public static function getPropertyAsObject(\stdClass $oObject, $sPropertyName)
    {
        if (!property_exists($oObject, $sPropertyName)) {
            throw new Exception\NotFound(sprintf('%s() Property [%s] not exist in object', __METHOD__, $sPropertyName));
        }
     ...
     */
    public static function saveFile($sPath, $content)
    {
