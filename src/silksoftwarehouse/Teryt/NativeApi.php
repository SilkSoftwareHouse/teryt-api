...
use silksoftwarehouse\Teryt\ResponseModel\Dictionary\RodzajMiejscowosci;
use silksoftwarehouse\Teryt\ResponseModel\Territory\JednostkaNomenklaturyNTS;
use silksoftwarehouse\Teryt\ResponseModel\Territory\JednostkaPodzialuTerytorialnego;
use silksoftwarehouse\Teryt\ResponseModel\Territory\JednostkaTerytorialna;
use silksoftwarehouse\Teryt\ResponseModel\Territory\Miejscowosc;
use silksoftwarehouse\Teryt\ResponseModel\Territory\Ulica;
use silksoftwarehouse\Teryt\ResponseModel\Territory\UlicaDrzewo;
use silksoftwarehouse\Teryt\ResponseModel\Territory\WyszukanaMiejscowosc;
use silksoftwarehouse\Teryt\ResponseModel\Territory\WyszukanaUlica;
use silksoftwarehouse\Teryt\ResponseModel\Territory\ZweryfikowanyAdres;
use silksoftwarehouse\Teryt\ResponseModel\Territory\ZweryfikowanyAdresBezUlic;
...
final class NativeApi
{
    ...
    /**
     * @var \silksoftwarehouse\Teryt\NativeApi|null
     */
     ...
     *
     * @param \silksoftwarehouse\Teryt\Client $oClient
     */
     ...
     * @param \silksoftwarehouse\Teryt\Client $oClient
     *
     * @return \silksoftwarehouse\Teryt\NativeApi
     */
    ...
    /**
     * @return \silksoftwarehouse\Teryt\NativeApi
     * @throws \silksoftwarehouse\Teryt\Exception
     */
     ...
     */
    public function PobierzKatalogTERCAdr()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogTERC()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogNTS()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogSIMCAdr()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogSIMC()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogSIMCStat()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogULIC()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogULICAdr()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogULICBezDzielnic()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzKatalogWMRODZ()
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzZmianyTercUrzedowy(\DateTime $fromDate, \DateTime $toDate = null)
    {
     ...
     * @return \SplFileObject
     */
    public function PobierzZmianyTercAdresowy(\DateTime $fromDate, \DateTime $toDate = null)
    {
        $toDate  = $toDate ?: new \DateTime();
        $res     = $this->oClient->request(
     ...
     * @return \SplFileObject
     */
    public function PobierzZmianyNTS(\DateTime $fromDate, \DateTime $toDate = null)
    {
        $toDate  = $toDate ?: new \DateTime();
        $res     = $this->oClient->request(
            'PobierzZmianyNTS',
     ...
     * @return \SplFileObject
     */
    public function PobierzZmianySimcUrzedowy(\DateTime $fromDate, \DateTime $toDate = null)
    {
        $toDate  = $toDate ?: new \DateTime();
        $res     = $this->oClient->request(
     ...
     * @return \SplFileObject
     */
    public function PobierzZmianySimcAdresowy(\DateTime $fromDate, \DateTime $toDate = null)
    {
        $toDate  = $toDate ?: new \DateTime();
        $res     = $this->oClient->request(
     ...
     * @return \SplFileObject
     */
    public function PobierzZmianySimcStatystyczny(\DateTime $fromDate, \DateTime $toDate = null)
    {
        $toDate  = $toDate ?: new \DateTime();
        $res     = $this->oClient->request(
     ...
     * @return \SplFileObject
     */
    public function PobierzZmianyUlicUrzedowy(\DateTime $fromDate, \DateTime $toDate = null)
    {
        $toDate  = $toDate ?: new \DateTime();
        $res     = $this->oClient->request(
     ...
     * @return \SplFileObject
     */
    public function PobierzZmianyUlicAdresowy(\DateTime $fromDate, \DateTime $toDate = null)
    {
        $toDate  = $toDate ?: new \DateTime();
        $res     = $this->oClient->request(
     ...
     * @return JednostkaNomenklaturyNTS[]
     */
    public function PobierzListeWojewodztwWRegionie($regionId)
    {
        $answer = [];
     ...
     * @return JednostkaNomenklaturyNTS[]
     */
    public function PobierzListePodregionow($provinceId)
    {
        $answer = [];
     ...
     * @return JednostkaNomenklaturyNTS[]
     */
    public function PobierzListePowiatowWPodregionie($subregionId)
    {
        $answer = [];
     ...
     * @return JednostkaNomenklaturyNTS[]
     */
    public function PobierzListeGminPowiecie($districtId, $subregionId)
    {
        $answer = [];
     ...
     */
    public function WyszukajJPT($name)
    {
        $answer = [];
     ...
     * @return Miejscowosc[]
     */
    public function WyszukajMiejscowosc($cityName = null, $cityId = null)
    {
        $answer = [];
     ...
     * @return Ulica[]
     */
    public function WyszukajUlice($streetName = null, $streetIdentityName = null, $cityName = null)
    {
        $answer = [];
    ...
    public function WyszukajMiejscowoscWRejestrze(
        ...
        array $tSimc = [],
        array $tTerc = [],
        $cityTypeName = NativeApi::SEARCH_CITY_TYPE_ALL
    ) {
        $answer     = [];
        $identyfiks = [];
        foreach ($tSimc as $simc) {
     ...
     */
    public function PobierzListeMiejscowosciWGminie($provinceName, $districtName, $communeName)
    {
        $answer = [];
     ...
     */
    public function PobierzListeMiejscowosciWRodzajuGminy($tercId)
    {
        $answer = [];
     ...
     * @return JednostkaTerytorialna[]
     */
    public function PobierzListePowiatow($provinceId)
    {
        $answer = [];
     ...
     * @return JednostkaTerytorialna[]
     */
    public function PobierzListeGmin($provinceId, $districtId)
    {
        $answer = [];
     ...
     * @return JednostkaTerytorialna[]
     */
    public function PobierzGminyiPowDlaWoj($provinceId)
    {
        $answer = [];
     ...
     * @return UlicaDrzewo[]
     */
    public function PobierzListeUlicDlaMiejscowosci($tercId, $cityId, $asAddress = false)
    {
        $answer = [];
        $oTerc  = new Terc($tercId);
     ...
     */
    public function WeryfikujAdresDlaMiejscowosci($cityId)
    {
     ...
     * @return ZweryfikowanyAdresBezUlic
     */
    public function WeryfikujAdresDlaMiejscowosciAdresowy($cityId)
    {
     ...
     */
    public function WeryfikujAdresDlaUlic($cityId, $streetId)
    {
     ...
     * @return ZweryfikowanyAdres
     */
    public function WeryfikujAdresDlaUlicAdresowy($cityId, $streetId)
    {
