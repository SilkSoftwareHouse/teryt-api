...
use silksoftwarehouse\Teryt\Exception\Connection;
use silksoftwarehouse\Teryt\Exception\Response;
...
class Client
{
     ...
     * SoapClient handler
     *
     * @var \silksoftwarehouse\Teryt\TerytSoapClient
     */
    private $soapClient;
    /**
     * Cache handler
     ...
     *
     */
    public function setConfig($username = null, $password = null, $isProduction = false)
    {
     ...
     *
     * @return \silksoftwarehouse\Teryt\Client
     ...
     * @throws \silksoftwarehouse\Teryt\Exception\Connection
     */
    public function request($method, array $args = [], $addDate = true)
    {
        try {
     ...
     * @return mixed
     */
    private function useCache(\Closure $closure, $hashKey, $ttl = null)
    {
        if ($this->oCache) {
     ...
     * Get SoapClient
     *
     * @return \silksoftwarehouse\Teryt\TerytSoapClient
     */
